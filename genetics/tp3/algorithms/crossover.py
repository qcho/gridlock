...
def _spawn_children(char_1: Character, char_2: Character) -> Tuple[Character, Character]:
...
def one_point(char_1: Character, char_2: Character) -> Tuple[Character, Character]:
...
def two_points(char_1: Character, char_2: Character) -> Tuple[Character, Character]:
...
def uniform(char_1: Character, char_2: Character) -> Tuple[Character, Character]:
    probability = 0.5
    child_1, child_2 = _spawn_children(char_1, char_2)
